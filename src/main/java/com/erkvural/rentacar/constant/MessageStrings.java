...
public class MessageStrings {
    ...
    public static final String CITYNAMENOTFOUND = "city.name.not.found";
    ...
    public static final String RENTALENDDATESORTED = "rental.end.date.sorted";
    ...
    public static final String CARMAINTENANCEPAGED = "car.maintenances.paged";
    public static final String CARMAINTENANCESORTED = "car.maintenances.sorted";
    ...
    public static final String CARMAINTENANCENGET = "car.maintenance.found";
    ...
    public static final String ADDITIONALSERVICEGET = "additional.service.found";
    public static final String ADDITIONALSERVICENOTIDFOUND = "additional.service.not.with.id.found";
    public static final String ADDITIONALSERVICENAMEERROR = "additional.service.exists";

    public static final String ORDEREDADDITIONALSERVICEADD = "ordered.additional.service.added";
    public static final String ORDEREDADDITIONALSERVICEDELETE = "ordered.additional.service.deleted";
    public static final String ORDEREDADDITIONALSERVICEUPDATE = "ordered.additional.service.updated";
